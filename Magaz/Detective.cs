...
namespace Magaz
{
    public partial class Detective : Form
    {
        public Detective()
        {
            ...
            MySqlCommand command = new MySqlCommand("SELECT * FROM earring", db.getConnection());
        ...
        private void label2_Click(object sender, EventArgs e)
        {
            ...
            MySqlCommand command = new MySqlCommand("SELECT * FROM earring WHERE name = @name", db.getConnection());
            ...
            if (table.Rows.Count > 0)
            {
                ...
                MySqlCommand command1 = new MySqlCommand("DELETE FROM earring WHERE earring.name = @name", db.getConnection());
