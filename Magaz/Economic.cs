...
namespace Magaz
{
    public partial class Economic : Form
    {
        public Economic()
        {
            ...
            MySqlCommand command = new MySqlCommand("SELECT * FROM pendant", db.getConnection());
        ...
        private void label2_Click(object sender, EventArgs e)
        {
            ...
            MySqlCommand command = new MySqlCommand("SELECT * FROM pendant WHERE name = @name", db.getConnection());
            ...
            if (table.Rows.Count > 0)
            {
                ...
                MySqlCommand command1 = new MySqlCommand("DELETE FROM pendant WHERE pendant.name = @name", db.getConnection());
