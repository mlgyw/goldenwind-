...
namespace Magaz
{
    public partial class Cooperative : Form
    {
        public Cooperative()
        {
            ...
            MySqlCommand command = new MySqlCommand("SELECT * FROM cufflincs", db.getConnection());
...
#region label for delete
        private void label2_Click(object sender, EventArgs e)
        {
            ...
            MySqlCommand command = new MySqlCommand("SELECT * FROM cufflincs WHERE name = @name", db.getConnection());
            ...
            if (table.Rows.Count > 0)
            {
                ...
                MySqlCommand command1 = new MySqlCommand("DELETE FROM cufflincs WHERE cufflincs.name = @name", db.getConnection());
