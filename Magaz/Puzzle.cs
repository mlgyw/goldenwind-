...
namespace Magaz
{
    public partial class Puzzle : Form
    {
        public Puzzle()
        {
            ...
            MySqlCommand command = new MySqlCommand("SELECT * FROM Bacelet", db.getConnection());
        ...
        private void label2_Click(object sender, EventArgs e)
        {
            ...
            MySqlCommand command = new MySqlCommand("SELECT * FROM Bacelet WHERE name = @name", db.getConnection());
            ...
            if (table.Rows.Count > 0)
            {
                ...
                MySqlCommand command1 = new MySqlCommand("DELETE FROM Bacelet WHERE Bacelet.name = @name", db.getConnection());
